        ...
        'Main_yard': {//Название сцены, называть также как и фото
            ...
            hotSpots: [
                ...
                },
                {
                    ...
                    yaw: -90,
                    type: 'info',
                    text: 'Восьмой корпус\nИнститут технологий и материалов (ИТМ)\nОсновные направления подготовки: машиностроение, автоматизация, материаловедение, мехатроника и робототехника, стандартизация и метрология.\n+7-908-350-21-59\niatm@ugatu.su'
                },
            ]
        },
        '1_build': {
        ...
        '2_build': {
            ...
            hotSpots: [
                ...
                },
                {
                    ...
                    yaw: 20,
                    type: 'info',
                    text: 'Факультет авиационных двигателей, энергетики и транспорта (ФАДЭТ)\nCтарейший факультет университета, готовящий специалистов для авиа- и ракетостроения, энергетики и транспорта. Обучение включает расчет, проектирование и эксплуатацию двигателей и энергетических установок с применением современных IT-технологий и автоматизированных лабораторий.\n+7-908-350-21-69\nfadet@ugatu.su',
                },
            ]
        },
        '2_build_1floor_1': {
        ...
        '3_build':{
            ...
            hotSpots: [
                ...
                }, 
                {
                    ...
                    yaw: 10,
                    type: 'info',
                    text: 'Институт экономики, управления и бизнеса (ИНЭБ)\nЗанимается подготовкой высококвалифицированных, конкурентоспособных и социально ответственных лидеров с современными экономическими, управленческими, предпринимательскими и цифровыми компетенциями для экономики, социальной сферы и государственного управления региона и других стран\nОтдел очного обучения\n+79083504991\ndekanat3407@ugatu.su\nОтдел заочного обучения\n+79083504992\nugatuinek317@mail.ru',
                }, 
            ]
        },   
        '3_build_1floor':{
        ...
        '6_build': {
            ...
            hotSpots: [
                ...
                },
                {
                    ...
                    yaw: 20,
                    type: 'info',
                    text: 'Институт информатики, математики и робототехники (ИИМРТ)\nВ институте студенты изучают фундаментальные и теоретические основы математики, информатики, кибернетики, искусственного интеллекта и архитектур операционных систем, а также получают практические навыки в программировании, базах данных, моделировании, информационной безопасности, микропроцессорных системах и интернете вещей \n+7 (347) 229-96-65\niimrt@uust.ru'
                },
            ]
        },
        ...
        '7_build_2floor_MF': {
            ...
            hotSpots: [
                ...
                },
                {
                    ...
                    yaw: -100,
                    type: 'info',
                    text: 'Режим работы:\nПрием абитуриентов и обучающихся до обеда 09.00-13.00\nОбед 13.00-14.00\nПрием абитуриентов и обучающихся после обеда 14.00-16.00\nРабота с документацией 16.00-18.00.\n+7 (917) -756-55-05\nospo@bashedu.ru',
                },
